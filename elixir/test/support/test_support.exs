defmodule SymphonyElixir.TestSupport do
    ...
    quote do
      ...
      setup do
        ...
        on_exit(fn ->
          ...
          Application.delete_env(:symphony_elixir, :economic_os_request_fun)
  ...
  defp workflow_content(overrides) do
    ...
    tracker_tenant = Keyword.get(config, :tracker_tenant)
    ...
    codex_auto_approve_tool_requests = Keyword.get(config, :codex_auto_approve_tool_requests)
    ...
    sections =
      [
        ...
        "  tenant: #{yaml_value(tracker_tenant)}",
        "polling:",
        ...
        "  auto_approve_tool_requests: #{yaml_value(codex_auto_approve_tool_requests)}",
